...
class AssignedToMe extends Component{
  static async getInitialProps(props){
    ...
    var contracts=await factory.methods.arrayGetAddress(props.query.address,"Receiver").call();
    var info_string=await factory.methods.summaryOfInfo(props.query.address,"Receiver").call();
    var status=await factory.methods.summaryOfStatus(props.query.address,"Receiver").call();
    console.log(status);
